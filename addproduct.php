...
<html lang="en">
  <head>
    ...
    <script>
      ...
      var contractAddress= '0x31C21A06D5647E573CB734924d6444f3DfA6901e';
  ...
  $("#aboutbtn").on("click", function(){
      showAlert("Our DApp is a Decentralized E2E Logistics Application that stores the whereabouts of medicines at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of the medicine and get complete information about the  product hence empowering consumers to only purchase authentic medicines.");
  });
