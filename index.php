...
<html lang="en">
  <head>
    ...
    <link rel="ICON" href="images/pill.png" type="image/ico" />

    <title>Medical Supply Chain - Decentralised Application</title>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> CS590 Blockchain Project : Medical Supply Chain DApp</h4>
            <p style="max-width: 80%;">
            Our DApp is a Decentralized E2E Logistics Application that stores the whereabouts of medicines at every freight hub on the Blockchain. At consumer end, customers can simply scan the QR CODE of the medicine and get complete information about the  product hence empowering consumers to only purchase authentic medicines.
            </p>
        <p>Developed by Kaushik and Ranjit</p>
